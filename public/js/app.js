...
// -------------------------------------------------------
const CONFIG = {
  // '.' にすることでフェッチURLが ./api/... となりページからの相対パスになる。
  // サブパス配置のリバースプロキシ（例: http://proxy/gis/）でも正しく解決される。
  API_BASE: '.',
...
// -------------------------------------------------------
document.getElementById('api-url-display').textContent = window.location.href.replace(/\/$/, '');
